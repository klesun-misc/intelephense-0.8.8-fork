...
class NameTextEditProvider {
    ...
    provideContractFqnTextEdits(uri, position, alias) {
        const kindMask = symbol_1.SymbolKind.Class | symbol_1.SymbolKind.Interface | symbol_1.SymbolKind.Trait | symbol_1.SymbolKind.Function | symbol_1.SymbolKind.Constant | symbol_1.SymbolKind.Constructor;
        let edits = [];
    ...
    _isFullyQualifiedName(node) {
        return node.phraseType === php7parser_1.PhraseType.FullyQualifiedName;
    }
}
