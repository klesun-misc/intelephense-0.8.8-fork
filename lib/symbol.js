...
(function (SymbolKind) {
    ...
    SymbolKind[SymbolKind["Interface"] = 2] = "Interface";
    SymbolKind[SymbolKind["Trait"] = 4] = "Trait";
    SymbolKind[SymbolKind["Constant"] = 8] = "Constant";
    SymbolKind[SymbolKind["Property"] = 16] = "Property";
    SymbolKind[SymbolKind["Method"] = 32] = "Method";
    SymbolKind[SymbolKind["Function"] = 64] = "Function";
    SymbolKind[SymbolKind["Parameter"] = 128] = "Parameter";
    SymbolKind[SymbolKind["Variable"] = 256] = "Variable";
    SymbolKind[SymbolKind["Namespace"] = 512] = "Namespace";
    SymbolKind[SymbolKind["ClassConstant"] = 1024] = "ClassConstant";
    SymbolKind[SymbolKind["Constructor"] = 2048] = "Constructor";
    SymbolKind[SymbolKind["File"] = 4096] = "File";
})(SymbolKind = exports.SymbolKind || (exports.SymbolKind = {}));
var SymbolModifier;
(function (SymbolModifier) {
    SymbolModifier[SymbolModifier["None"] = 0] = "None";
    SymbolModifier[SymbolModifier["Public"] = 1] = "Public";
    SymbolModifier[SymbolModifier["Protected"] = 2] = "Protected";
    SymbolModifier[SymbolModifier["Private"] = 4] = "Private";
    SymbolModifier[SymbolModifier["Final"] = 8] = "Final";
    SymbolModifier[SymbolModifier["Abstract"] = 16] = "Abstract";
    SymbolModifier[SymbolModifier["Static"] = 32] = "Static";
    SymbolModifier[SymbolModifier["ReadOnly"] = 64] = "ReadOnly";
    SymbolModifier[SymbolModifier["WriteOnly"] = 128] = "WriteOnly";
    SymbolModifier[SymbolModifier["Magic"] = 256] = "Magic";
    SymbolModifier[SymbolModifier["Anonymous"] = 512] = "Anonymous";
    SymbolModifier[SymbolModifier["Reference"] = 1024] = "Reference";
    SymbolModifier[SymbolModifier["Variadic"] = 2048] = "Variadic";
    SymbolModifier[SymbolModifier["Use"] = 4096] = "Use";
})(SymbolModifier = exports.SymbolModifier || (exports.SymbolModifier = {}));
var PhpSymbolDoc;
